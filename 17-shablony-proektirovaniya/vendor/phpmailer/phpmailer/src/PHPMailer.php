...
class PHPMailer
{
    ...
    public static function _mime_types($ext = '')
    {
        $mimes = [
            ...
            'xlam' => 'application/vnd.ms-excel.addin.macroEnabled.12-avtozagruzka-i-prostranstva-imen',
            'xlsb' => 'application/vnd.ms-excel.sheet.binary.macroEnabled.12-avtozagruzka-i-prostranstva-imen',
